					...
					foreach ($data as $key => $value) {						
						echo '<div class="card card-inverse card-info mb-3" style="padding:1%;">					
								  <div class="card-block">';
								  	...
								  	echo '<a class="btn btn-warning mr-2" href="update.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '">Edit</a>';
								  	echo '<a class="btn btn-danger" href="delete.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '" onclick="return confirm(\'Are you sure you want to delete this apartment?\')">Delete</a>';
								  	echo '</div>';
									 echo 	'<div class="row">
											<div class="col-4">
